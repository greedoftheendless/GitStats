...
export default function AuthScreen({ onJoin, onCreate }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-72 h-72 bg-violet-500 rounded-full mix-blend-screen filter blur-3xl opacity-10 animate-pulse"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {mode === 'join' && (
          <div className="space-y-4 animate-in fade-in duration-300">
            ...
            <button
              onClick={handleJoin}
              className="w-full px-4 py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-cyan-600 text-white font-semibold hover:from-cyan-600 hover:to-cyan-700 transition transform hover:scale-105 active:scale-95"
            >
              Join Session
            </button>
          </div>
        ...
        {mode === 'create' && (
          <div className="space-y-4 animate-in fade-in duration-300">
            ...
            <button
              ...
              className="w-full px-4 py-3 rounded-lg bg-gradient-to-r from-violet-500 to-violet-600 text-white font-semibold hover:from-violet-600 hover:to-violet-700 transition transform hover:scale-105 active:scale-95"
            >
              Create Session
            </button>
          </div>
